...
export interface TaskResult {
  ...
  description: string;
  result?: any;
  error?: string | { message: string; type: string; recoverable: boolean; suggestedAction: string };
  startTime: Date;
  endTime?: Date;
  duration?: number;
  tokens?: number;
