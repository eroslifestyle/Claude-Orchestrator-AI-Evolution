...
export type KeywordMatchType =
  | 'direct'     // Match diretto
  | 'partial'    // Match parziale
  | 'inferred';  // Match inferito dal contesto
...
export type ComplexityFactorType =
  | 'domain_count'        // Numero domini
  | 'keyword_density'     // Densità keyword nel testo
  | 'dependency_depth'    // Profondità dipendenze
  | 'ambiguity_level'     // Livello ambiguità
  | 'security_sensitivity'// Criticità security
  | 'integration_complexity' // Complessità integrazioni
  | 'performance_requirements' // Requisiti performance
  | 'resource_intensity'; // Intensità risorse
...
export interface ComplexityAssessment {
  ...
  estimates: {
    ...
    costDollars: number;
    agentCount: number;
    parallelizability: number; // 0.0-1.0
  };
...
// =============================================================================
// ADDITIONAL INTEGRATION RESILIENCE TYPES
// =============================================================================
...
// EXPORTS
// =============================================================================
// All types are already exported inline with their declarations - no duplicate exports needed