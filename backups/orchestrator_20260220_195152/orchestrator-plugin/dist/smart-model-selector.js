...
exports.modelSelector = exports.SmartModelSelector = void 0;
...
class SmartModelSelector {
     ...
     */
    analyzeTask(description, agentFile, context) {
        ...
        // Check complessità
        const hasHighComplexity = HIGH_COMPLEXITY_KEYWORDS.some(k => lowerDesc.includes(k) || lowerAgent.includes(k));
        // Check ripetitività
        const isRepetitive = REPETITIVE_KEYWORDS.some(k => lowerDesc.includes(k));
        // Check pensiero laterale
        const requiresLateralThinking = LATERAL_THINKING_KEYWORDS.some(k => lowerDesc.includes(k));
     ...
     */
    selectModel(description, agentFile, context) {
     ...
     */
    estimateTokens(description, complexity) {
...
exports.SmartModelSelector = SmartModelSelector;
// Singleton instance
exports.modelSelector = new SmartModelSelector();
