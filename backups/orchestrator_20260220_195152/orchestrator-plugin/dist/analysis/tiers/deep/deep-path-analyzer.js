...
exports.DeepPathAnalyzer = void 0;
// =============================================================================
...
class DeepPathAnalyzer {
     ...
     */
    createStubErrorResult(errorType, startTime, error) {
        return {
            success: false,
            error: {
                tier: 'deep',
    ...
    getStubErrorMessage(errorType) {
        ...
        return messages[errorType] || 'Deep Path error sconosciuto';
    }
}
exports.DeepPathAnalyzer = DeepPathAnalyzer;
//# sourceMappingURL=deep-path-analyzer.js.map