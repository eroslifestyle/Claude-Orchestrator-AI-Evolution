...
exports.FastPathAnalyzer = void 0;
...
class FastPathAnalyzer {
    ...
    constructor(config) {
        ...
        this.patternCache = new cache_manager_1.PatternCache();
    ...
    extractKeywordsFast(text) {
        ...
        for (const pattern of this.patterns) {
            ...
            for (const match of matches) {
                ...
                const confidenceContext = (0, confidence_scorer_1.createConfidenceContext)(tempKeyword, text, 'fast', {
                    domainCount: 1,
    ...
    compileRegexPatterns() {
        ...
        for (const [domain, mapping] of Object.entries(domainMappings)) {
            const keywords = [...mapping.keywords]; // Convert readonly array to mutable
    ...
    getQuickConfidenceScore(text) {
        ...
        for (const pattern of this.patterns) {
            ...
            if (match && match.index !== undefined) {
                ...
                const quickContext = (0, confidence_scorer_1.createConfidenceContext)(quickKeyword, text, 'fast');
     ...
     */
    findOriginalKeyword(matchedText, keywords) {
        const exact = keywords.find(kw => this.config.caseSensitive ? kw === matchedText : kw.toLowerCase() === matchedText.toLowerCase());
...
exports.FastPathAnalyzer = FastPathAnalyzer;
//# sourceMappingURL=fast-path-analyzer.js.map