...
exports.runAllExamples = exports.example10_ErrorHandling = exports.example9_RealTimeUpdates = exports.example8_AgentCoordination = exports.example7_Observability = exports.example6_EndToEndExecution = exports.example5_FaultTolerantExecution = exports.example4_ContextPooling = exports.example3_RequestRouting = exports.example2_MessagePubSub = exports.example1_BasicSetup = void 0;
// ============================================================================
// IMPORTS
// ============================================================================
const CentralCommunicationHub_1 = require("../CentralCommunicationHub");
// ============================================================================
...
async function example1_BasicSetup() {
    ...
    const hub = await (0, CentralCommunicationHub_1.createHub)({
 ...
 */
async function example2_MessagePubSub() {
    console.log('\n=== Example 2: Message Pub/Sub ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example2_MessagePubSub = example2_MessagePubSub;
// ============================================================================
 ...
 */
async function example3_RequestRouting() {
    console.log('\n=== Example 3: Request Routing ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example3_RequestRouting = example3_RequestRouting;
// ============================================================================
 ...
 */
async function example4_ContextPooling() {
    console.log('\n=== Example 4: Context Pooling ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example4_ContextPooling = example4_ContextPooling;
// ============================================================================
 ...
 */
async function example5_FaultTolerantExecution() {
    console.log('\n=== Example 5: Fault Tolerant Execution ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example5_FaultTolerantExecution = example5_FaultTolerantExecution;
// ============================================================================
 ...
 */
async function example6_EndToEndExecution() {
    console.log('\n=== Example 6: End-to-End Task Execution ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example6_EndToEndExecution = example6_EndToEndExecution;
// ============================================================================
 ...
 */
async function example7_Observability() {
    console.log('\n=== Example 7: Observability and Monitoring ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
...
exports.example7_Observability = example7_Observability;
// ============================================================================
 ...
 */
async function example8_AgentCoordination() {
    console.log('\n=== Example 8: Multi-Agent Coordination ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
    ...
    const dbResult = await hub.executeWithRouting({ request: `Design database schema for: ${taskRequest}` }, async (ctx) => {
    ...
    const secResult = await hub.executeWithRouting({ request: `Implement JWT authentication for: ${taskRequest}` }, async (ctx) => {
        await hub.publish('coordination.progress', {
            step: 2,
            agent: ctx.agentType,
    ...
    const guiResult = await hub.executeWithRouting({ request: `Create login form GUI for: ${taskRequest}` }, async (ctx) => {
        await hub.publish('coordination.progress', {
            step: 3,
            agent: ctx.agentType,
...
exports.example8_AgentCoordination = example8_AgentCoordination;
// ============================================================================
 ...
 */
async function example9_RealTimeUpdates() {
    console.log('\n=== Example 9: Real-Time Updates ===\n');
    const hub = await (0, CentralCommunicationHub_1.createDevHub)();
    ...
    const subscriptions = [
        ...
        hub.subscribe('updates.progress.*', async (msg) => {
            console.log(`[PROGRESS] ${msg.payload.percent}%`);
        }),
...
exports.example9_RealTimeUpdates = example9_RealTimeUpdates;
// ============================================================================
