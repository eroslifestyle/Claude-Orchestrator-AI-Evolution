...
exports.DOMAIN_FALLBACKS = exports.FALLBACK_MAPPING = exports.OrchestratorQuickFixer = void 0;
...
exports.FALLBACK_MAPPING = FALLBACK_MAPPING;
/**
...
exports.DOMAIN_FALLBACKS = DOMAIN_FALLBACKS;
// ============================================================================
...
class OrchestratorQuickFixer {
     ...
     */
    findLevelBasedFallback(agentPath) {
     ...
     */
    shouldAllowSubSpawning(agentFile, availableSubAgents) {
        ...
        const existingSubAgents = potentialSubAgents.filter(subAgent => availableSubAgents.includes(subAgent));
     ...
     */
    getPotentialSubAgents(agentFile) {
     ...
     */
    getAdaptiveComplexityThreshold(agentFile, hasSubAgents) {
        if (!hasSubAgents) {
...
`;
    ...
    countMappingsForDomain(domain) {
        return Object.keys(FALLBACK_MAPPING).filter(key => key.toLowerCase().includes(domain)).length;
    }
}
exports.OrchestratorQuickFixer = OrchestratorQuickFixer;
// ============================================================================
...
//# sourceMappingURL=orchestrator-quick-fixes.js.map